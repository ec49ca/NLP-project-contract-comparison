...
class CorrelationAnalysisTool:
                    ...
                    for j, field2 in enumerate(target_fields):
                        if i == j:
                            ...
                            if correlation_result:
                                ...
                                method_significance[field1][field2] = correlation_result["p_value"]
                            else:
                                method_correlations[field1][field2] = {
                                    "correlation": 0.0,
                                    "p_value": 1.0,
    ...
    def _calculate_correlation(self, data: List[Dict[str, Any]], field1: str, field2: str, method: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            for row in data:
                ...
                if (isinstance(val1, (int, float)) and isinstance(val2, (int, float)) and 
                    not isinstance(val1, bool) and not isinstance(val2, bool) and
            ...
            interpretation = self._interpret_correlation(correlation, significance, field1, field2)
            ...
            logger.error(f"Error calculating {method} correlation between {field1} and {field2}: {e}")
            return None
    ...
    def _interpret_correlation(self, correlation: float, significance: str, field1: str, field2: str) -> str:
    ...
    def _find_strong_correlations(self, correlations: Dict[str, Any], fields: List[str]) -> List[Dict[str, Any]]:
    ...
    def _calculate_correlation_summary(self, correlations: Dict[str, Any], fields: List[str]) -> Dict[str, Any]:
        ...
        for method in correlations.keys():
            ...
            correlations_list = []
            significance_counts = {"extreme": 0, "high": 0, "medium": 0, "low": 0, "none": 0}
