...
This tool provides Ridge regression capabilities with L2 regularization including:
...
class RidgeRegressionTool:
    """Tool for Ridge regression with L2 regularization"""
    
    def __init__(self):
        self.name = "ridge_regression"
        self.description = "Perform Ridge regression with L2 regularization for handling multicollinearity. Includes configurable alpha, feature standardization, and regularization metrics."
        self.llm_service = llm_service

    async def execute_tool(self, arguments: Dict[str, Any]) -> Any:
        """Execute the Ridge regression tool"""
        try:
            ...
            if not target_field:
                return {
                    ...
                    "summary": "Target field is required for Ridge regression analysis."
                }
            ...
            if len(valid_data) < 2:
                return {
                    ...
                    "summary": "Insufficient valid data points for Ridge regression analysis."
                }
            ...
            try:
                ...
                result = self._ridge_regression(X_train, X_test, y_train, y_test, feature_names, hyperparameters)
                ...
                return {
                    ...
                    "summary": f"Ridge regression analysis completed successfully."
                }
            except Exception as e:
                return {
                    "status": "error",
                    ...
                    "summary": f"Ridge regression error: {str(e)}"
                }
    ...
    def _ridge_regression(self, X_train: np.ndarray, X_test: np.ndarray, 
        ...
        try:
            ...
            regularization_metrics = {
                ...
                "effective_degrees_of_freedom": float(model.n_features_in_)
            }
            ...
            return {
                ...
                "summary": f"Ridge regression (α={alpha}) completed with R² = {r2_test:.4f}, MSE = {mse_test:.4f}"
            }
